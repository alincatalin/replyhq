...
actual class ChatSDKInitializer private constructor(
    ...
    private val databaseWrapper = ChatDatabaseWrapper(DatabaseDriverFactory())
    ...
    companion object {
        fun create(appId: String, apiKey: String): ChatSDKInitializer {
            val config = ChatConfig(appId = appId, apiKey = apiKey)
            return ChatSDKInitializer(config)
        }
        
        fun create(config: ChatConfig): ChatSDKInitializer {
            return ChatSDKInitializer(config)
        }
    }
}
